...
export const PDF_IMAGE_MIN_SPLIT_PERCENTAGE = 100; // Minimum % of image on next page to justify splitting (otherwise scale down) - TEMPORARILY SET TO 100 TO DISABLE SPLITTING
